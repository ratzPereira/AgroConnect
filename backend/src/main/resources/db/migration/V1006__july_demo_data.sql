...
--
-- ID strategy
--   All NEW explicit IDs start at 3000+, disjoint from V999/V1000/V1001
...
-- ═══════════════════════════════════════════════════════════════
-- PART 0 — Defensive guards (abort atomically if 3000+ already used)
-- ═══════════════════════════════════════════════════════════════
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM service_requests   WHERE id BETWEEN 3001 AND 3020) THEN
    RAISE EXCEPTION 'V1006 aborted: service_requests.id 3001-3020 already in use. Bump V1006 ID range.';
  END IF;
  IF EXISTS (SELECT 1 FROM proposals          WHERE id BETWEEN 3001 AND 3022) THEN
    RAISE EXCEPTION 'V1006 aborted: proposals.id 3001-3022 already in use. Bump V1006 ID range.';
  END IF;
  IF EXISTS (SELECT 1 FROM service_executions WHERE id BETWEEN 3001 AND 3018) THEN
    RAISE EXCEPTION 'V1006 aborted: service_executions.id 3001-3018 already in use. Bump V1006 ID range.';
  END IF;
END $$;


-- ═══════════════════════════════════════════════════════════════
-- PART 1 — Service Requests (IDs 3001-3020)
-- ═══════════════════════════════════════════════════════════════
...
(3001, 2, 1, 'COMPLETED', 'Lavoura de pastagem para resseada de verão — 5 hectares',
...
(3002, 3, 2, 'COMPLETED', 'Pulverização fungicida em pomar — 2 hectares',
...
(3003, 4, 1, 'COMPLETED', 'Gradagem e nivelamento — 3 hectares',
...
(3004, 5, 2, 'COMPLETED', 'Aplicação de herbicida em milho — 4 hectares',
...
(3005, 1020, 1, 'COMPLETED', 'Fresagem fina de canteiros — 2.5 hectares',
...
INSERT INTO service_requests (id, client_id, category_id, status, title, description, location, parish, municipality, island, area, area_unit, urgency, preferred_date_from, preferred_date_to, form_data, created_at) VALUES
(3006, 2, 1, 'RATED', 'Subsolagem de terreno compactado — 4 hectares',
...
(3007, 3, 2, 'RATED', 'Tratamento de vinha contra míldio — 1.5 hectares',
...
(3008, 11, 1, 'RATED', 'Lavoura de pousio — 6 hectares (Faial)',
...
INSERT INTO service_requests (id, client_id, category_id, status, title, description, location, parish, municipality, island, area, area_unit, urgency, preferred_date_from, preferred_date_to, form_data, created_at) VALUES
(3009, 4, 2, 'AWAITING_CONFIRMATION', 'Adubação de pastagem com NPK — 5 hectares',
...
(3010, 1021, 5, 'AWAITING_CONFIRMATION', 'Limpeza de terreno com destroçador — 2 hectares',
...
INSERT INTO service_requests (id, client_id, category_id, status, title, description, location, parish, municipality, island, area, area_unit, urgency, preferred_date_from, preferred_date_to, form_data, created_at) VALUES
(3011, 2, 1, 'IN_PROGRESS', 'Lavoura de terreno para milho — 4 hectares',
...
(3012, 1020, 2, 'IN_PROGRESS', 'Pulverização de pomar de citrinos — 2 hectares',
...
(3013, 3, 4, 'IN_PROGRESS', 'Transporte de fardos de feno — Terceira',
...
INSERT INTO service_requests (id, client_id, category_id, status, title, description, location, parish, municipality, island, area, area_unit, urgency, preferred_date_from, preferred_date_to, form_data, created_at) VALUES
(3014, 5, 1, 'AWARDED', 'Gradagem antes de sementeira — 3 hectares',
...
(3015, 1022, 2, 'AWARDED', 'Tratamento herbicida em horta — 1.5 hectares',
...
(3016, 2, 1, 'AWARDED', 'Lavoura de encosta — 5 hectares',
...
(3017, 3, 3, 'AWARDED', 'Colheita de erva e enfardamento — 4 hectares',
...
(3018, 11, 2, 'AWARDED', 'Atomização de pomar — 2 hectares (Faial)',
...
INSERT INTO service_requests (id, client_id, category_id, status, title, description, location, parish, municipality, island, area, area_unit, urgency, preferred_date_from, preferred_date_to, form_data, created_at) VALUES
(3019, 2, 1, 'WITH_PROPOSALS', 'Subsolagem de pastagem — 6 hectares',
...
(3020, 1020, 2, 'WITH_PROPOSALS', 'Tratamento de batata — 3 hectares',
...
-- ═══════════════════════════════════════════════════════════════
-- PART 2 — Proposals (IDs 3001-3022)
-- ═══════════════════════════════════════════════════════════════
-- ACCEPTED proposals by provider 1 for requests 3001-3018.
...
(3001, 3001, 1, 'ACCEPTED', 650.00, 'PER_UNIT', 130.00, 5,   'Lavoura com New Holland T5.120 e charrua reversível 3 ferros. 1 dia.', 'Mão de obra, máquina, combustível', 'Gradagem posterior', '2026-07-04', '2026-06-29 10:00:00'),
(3002, 3002, 1, 'ACCEPTED', 320.00, 'PER_UNIT', 160.00, 2,   'Pulverização com atomizador 800L. Operador experiente em pomares.',   'Mão de obra, máquina, deslocação', 'Produtos (fornecidos pelo cliente)', '2026-07-05', '2026-06-30 09:00:00'),
(3003, 3003, 1, 'ACCEPTED', 270.00, 'PER_UNIT',  90.00, 3,   'Gradagem em duas passagens cruzadas. John Deere 6120M + grade 28".',   'Mão de obra, máquina, combustível', 'Sementeira', '2026-07-06', '2026-07-01 11:00:00'),
(3004, 3004, 1, 'ACCEPTED', 280.00, 'PER_UNIT',  70.00, 4,   'Aplicação herbicida com pulverizador 2000L. Trabalho matinal.',       'Mão de obra, máquina, deslocação', 'Produto herbicida (cliente)', '2026-07-07', '2026-07-02 08:30:00'),
(3005, 3005, 1, 'ACCEPTED', 250.00, 'PER_UNIT', 100.00, 2.5, 'Fresagem fina com Massey Ferguson 4707 e fresa 2m.',                  'Mão de obra, máquina, combustível', 'Remoção de pedras', '2026-07-08', '2026-07-03 14:00:00'),
(3006, 3006, 1, 'ACCEPTED', 480.00, 'PER_UNIT', 120.00, 4,   'Subsolagem profunda com subsolador montado em New Holland T5.120.',   'Mão de obra, máquina, combustível', 'Gradagem posterior', '2026-07-03', '2026-06-28 09:00:00'),
(3007, 3007, 1, 'ACCEPTED', 240.00, 'PER_UNIT', 160.00, 1.5, 'Tratamento de vinha com atomizador 800L. Cobertura cuidada.',         'Mão de obra, máquina, deslocação', 'Produto fungicida (cliente)', '2026-07-04', '2026-06-29 16:00:00'),
(3008, 3008, 1, 'ACCEPTED', 780.00, 'PER_UNIT', 130.00, 6,   'Lavoura profunda inter-ilhas (Faial). New Holland + charrua reversível.', 'Mão de obra, máquina, deslocação inter-ilhas', 'Gradagem', '2026-07-05', '2026-06-30 10:30:00'),
(3009, 3009, 1, 'ACCEPTED', 450.00, 'PER_UNIT',  90.00, 5,   'Aplicação de NPK 20-10-10 com pulverizador 2000L. Distribuição uniforme.', 'Mão de obra, máquina, deslocação', 'Produto adubo (cliente)', '2026-07-09', '2026-07-03 09:00:00'),
(3010, 3010, 1, 'ACCEPTED', 260.00, 'PER_UNIT', 130.00, 2,   'Limpeza com destroçador florestal. Trabalho de meio dia.',            'Mão de obra, máquina, combustível', 'Remoção de troncos', '2026-07-09', '2026-07-03 15:00:00'),
(3011, 3011, 1, 'ACCEPTED', 520.00, 'PER_UNIT', 130.00, 4,   'Lavoura com charrua reversível. New Holland T5.120.',                 'Mão de obra, máquina, combustível', 'Gradagem posterior', '2026-07-10', '2026-07-07 09:00:00'),
(3012, 3012, 1, 'ACCEPTED', 320.00, 'PER_UNIT', 160.00, 2,   'Pulverização com atomizador 800L em pomar de citrinos.',              'Mão de obra, máquina, deslocação', 'Produtos (cliente)', '2026-07-10', '2026-07-07 10:00:00'),
(3013, 3013, 1, 'ACCEPTED', 160.00, 'FIXED',   NULL, NULL,   'Transporte de 40 fardos com Iveco Daily. Carga e descarga incluídas.', 'Mão de obra, viatura, combustível', 'Empilhamento no destino', '2026-07-10', '2026-07-08 11:00:00'),
(3014, 3014, 1, 'ACCEPTED', 240.00, 'PER_UNIT',  80.00, 3,   'Gradagem com John Deere 6120M e grade de discos 28".',                'Mão de obra, máquina, combustível', 'Sementeira', '2026-07-11', '2026-07-05 09:00:00'),
(3015, 3015, 1, 'ACCEPTED', 195.00, 'PER_UNIT', 130.00, 1.5, 'Aplicação herbicida com pulverizador 2000L. Aplicação matinal.',      'Mão de obra, máquina, deslocação', 'Produto herbicida (cliente)', '2026-07-12', '2026-07-06 10:00:00'),
(3016, 3016, 1, 'ACCEPTED', 650.00, 'PER_UNIT', 130.00, 5,   'Lavoura profunda em encosta. New Holland + charrua reversível.',      'Mão de obra, máquina, combustível', 'Gradagem posterior', '2026-07-14', '2026-07-07 09:30:00'),
(3017, 3017, 1, 'ACCEPTED', 480.00, 'PER_UNIT', 120.00, 4,   'Colheita de erva seca e enfardamento. Ceifeira Claas + enfardadeira.', 'Mão de obra, máquina, combustível', 'Transporte para armazém', '2026-07-16', '2026-07-08 14:00:00'),
(3018, 3018, 1, 'ACCEPTED', 320.00, 'PER_UNIT', 160.00, 2,   'Atomização de copa com atomizador 800L. Deslocação inter-ilhas.',     'Mão de obra, máquina, deslocação inter-ilhas', 'Produto fungicida', '2026-07-18', '2026-07-09 10:00:00');

-- PENDING proposals for WITH_PROPOSALS requests 3019-3020 (provider 1 + provider 2)
...
(3019, 3019, 1, 'PENDING', 720.00, 'PER_UNIT', 120.00, 6, 'Subsolagem com subsolador montado em New Holland T5.120. Trabalho cuidado.', 'Mão de obra, máquina, combustível', 'Gradagem posterior', '2026-07-20', '2026-07-18 23:59:59', '2026-07-09 09:00:00'),
(3020, 3019, 2, 'PENDING', 690.00, 'PER_UNIT', 115.00, 6, 'Subsolagem com John Deere 6130M. Gradagem opcional por valor adicional.',    'Mão de obra, máquina, deslocação', 'Gradagem (à parte)', '2026-07-21', '2026-07-18 23:59:59', '2026-07-09 12:00:00'),
(3021, 3020, 1, 'PENDING', 360.00, 'PER_UNIT', 120.00, 3, 'Tratamento fungicida preventivo com atomizador 800L.',                       'Mão de obra, máquina, deslocação', 'Produto fungicida', '2026-07-19', '2026-07-17 23:59:59', '2026-07-09 11:30:00'),
(3022, 3020, 2, 'PENDING', 345.00, 'PER_UNIT', 115.00, 3, 'Tratamento com pulverizador 2000L. Aplicação rápida.',                       'Mão de obra, máquina, deslocação', 'Produto fungicida', '2026-07-20', '2026-07-17 23:59:59', '2026-07-09 13:00:00');


-- ═══════════════════════════════════════════════════════════════
-- PART 3 — Transactions (IDs 3001-3018)
-- ═══════════════════════════════════════════════════════════════
...
(3001, 3001, 3001, 650.00, 0.12, 78.00, 572.00, 'RELEASED', '2026-07-04 08:00:00', '2026-07-07 10:00:00', '2026-06-29 10:00:00'),
(3002, 3002, 3002, 320.00, 0.12, 38.40, 281.60, 'RELEASED', '2026-07-05 08:00:00', '2026-07-08 10:00:00', '2026-06-30 09:00:00'),
(3003, 3003, 3003, 270.00, 0.12, 32.40, 237.60, 'RELEASED', '2026-07-06 08:00:00', '2026-07-09 10:00:00', '2026-07-01 11:00:00'),
(3004, 3004, 3004, 280.00, 0.12, 33.60, 246.40, 'RELEASED', '2026-07-07 08:00:00', '2026-07-10 10:00:00', '2026-07-02 08:30:00'),
(3005, 3005, 3005, 250.00, 0.12, 30.00, 220.00, 'RELEASED', '2026-07-08 08:00:00', '2026-07-11 10:00:00', '2026-07-03 14:00:00'),
(3006, 3006, 3006, 480.00, 0.12, 57.60, 422.40, 'RELEASED', '2026-07-03 08:00:00', '2026-07-06 10:00:00', '2026-06-28 09:00:00'),
(3007, 3007, 3007, 240.00, 0.12, 28.80, 211.20, 'RELEASED', '2026-07-04 08:00:00', '2026-07-07 10:00:00', '2026-06-29 16:00:00'),
(3008, 3008, 3008, 780.00, 0.12, 93.60, 686.40, 'RELEASED', '2026-07-05 08:00:00', '2026-07-08 10:00:00', '2026-06-30 10:30:00');
...
(3009, 3009, 3009, 450.00, 0.12, 54.00, 396.00, 'HELD', '2026-07-09 08:00:00', '2026-07-03 09:00:00'),
(3010, 3010, 3010, 260.00, 0.12, 31.20, 228.80, 'HELD', '2026-07-09 08:00:00', '2026-07-03 15:00:00'),
(3011, 3011, 3011, 520.00, 0.12, 62.40, 457.60, 'HELD', '2026-07-08 09:00:00', '2026-07-07 09:00:00'),
(3012, 3012, 3012, 320.00, 0.12, 38.40, 281.60, 'HELD', '2026-07-08 09:00:00', '2026-07-07 10:00:00'),
(3013, 3013, 3013, 160.00, 0.12, 19.20, 140.80, 'HELD', '2026-07-09 09:00:00', '2026-07-08 11:00:00'),
(3014, 3014, 3014, 240.00, 0.12, 28.80, 211.20, 'HELD', '2026-07-06 09:00:00', '2026-07-05 09:00:00'),
(3015, 3015, 3015, 195.00, 0.12, 23.40, 171.60, 'HELD', '2026-07-07 09:00:00', '2026-07-06 10:00:00'),
(3016, 3016, 3016, 650.00, 0.12, 78.00, 572.00, 'HELD', '2026-07-08 09:00:00', '2026-07-07 09:30:00'),
(3017, 3017, 3017, 480.00, 0.12, 57.60, 422.40, 'HELD', '2026-07-09 09:00:00', '2026-07-08 14:00:00'),
(3018, 3018, 3018, 320.00, 0.12, 38.40, 281.60, 'HELD', '2026-07-09 09:00:00', '2026-07-09 10:00:00');


-- ═══════════════════════════════════════════════════════════════
-- PART 4 — Service Executions (IDs 3001-3018) with calendar metadata
-- ═══════════════════════════════════════════════════════════════
-- COMPLETED (full lifecycle) — executions 3001-3005
...
(3001, 3001, ST_SetSRID(ST_MakePoint(-27.2050, 38.6720), 4326), '2026-07-04 07:30:00', '2026-07-04 17:30:00',
...
(3002, 3002, ST_SetSRID(ST_MakePoint(-27.0700, 38.7250), 4326), '2026-07-05 08:00:00', '2026-07-05 13:00:00',
...
(3003, 3003, ST_SetSRID(ST_MakePoint(-25.6750, 37.7320), 4326), '2026-07-06 08:00:00', '2026-07-06 15:00:00',
...
(3004, 3004, ST_SetSRID(ST_MakePoint(-25.5200, 37.8150), 4326), '2026-07-07 07:30:00', '2026-07-07 12:30:00',
...
(3005, 3005, ST_SetSRID(ST_MakePoint(-27.2300, 38.6700), 4326), '2026-07-08 08:30:00', '2026-07-08 14:30:00',
...
-- RATED (full lifecycle) — executions 3006-3008
...
(3006, 3006, ST_SetSRID(ST_MakePoint(-27.2120, 38.6650), 4326), '2026-07-03 07:30:00', '2026-07-03 18:00:00',
...
(3007, 3007, ST_SetSRID(ST_MakePoint(-27.0530, 38.7390), 4326), '2026-07-04 08:00:00', '2026-07-04 12:00:00',
...
(3008, 3008, ST_SetSRID(ST_MakePoint(-28.7180, 38.5340), 4326), '2026-07-05 07:00:00', '2026-07-06 17:00:00',
...
-- AWAITING_CONFIRMATION (finished, not yet confirmed) — executions 3009-3010
INSERT INTO service_executions (id, proposal_id, checkin_location, checkin_time, checkout_time, notes, materials_used, completed_at, scheduled_date, scheduled_end_date, scheduled_start_time, scheduled_end_time, scheduled_all_day, created_at) VALUES
(3009, 3009, ST_SetSRID(ST_MakePoint(-25.6730, 37.7390), 4326), '2026-07-09 08:00:00', '2026-07-09 14:00:00',
...
(3010, 3010, ST_SetSRID(ST_MakePoint(-27.0500, 38.7400), 4326), '2026-07-09 09:00:00', '2026-07-09 13:30:00',
...
-- IN_PROGRESS (checked in, running TODAY) — executions 3011-3013
...
(3011, 3011, ST_SetSRID(ST_MakePoint(-27.2100, 38.6750), 4326), '2026-07-10 07:45:00', NULL, '2026-07-10', '2026-07-10', '07:30:00', '16:00:00', FALSE, '2026-07-07 09:00:00'),
(3012, 3012, ST_SetSRID(ST_MakePoint(-27.0610, 38.7330), 4326), '2026-07-10 09:10:00', NULL, '2026-07-10', '2026-07-10', '09:00:00', '13:00:00', FALSE, '2026-07-07 10:00:00'),
(3013, 3013, ST_SetSRID(ST_MakePoint(-27.0680, 38.7260), 4326), '2026-07-10 13:20:00', NULL, '2026-07-10', '2026-07-11', '13:00:00', '17:30:00', FALSE, '2026-07-08 11:00:00');

-- AWARDED (scheduled future, hourly slots, no check-in) — executions 3014-3018
...
(3014, 3014, NULL, '2026-07-11', '2026-07-11', '08:00:00', '14:00:00', FALSE, '2026-07-05 09:00:00'),
(3015, 3015, NULL, '2026-07-12', '2026-07-12', '07:30:00', '11:30:00', FALSE, '2026-07-06 10:00:00'),
(3016, 3016, NULL, '2026-07-14', '2026-07-15', '08:00:00', '17:30:00', FALSE, '2026-07-07 09:30:00'),
(3017, 3017, NULL, '2026-07-16', '2026-07-16', '07:00:00', '15:00:00', FALSE, '2026-07-08 14:00:00'),
(3018, 3018, NULL, '2026-07-18', '2026-07-18', '09:00:00', '14:30:00', FALSE, '2026-07-09 10:00:00');
...
(3001,    2,    1, 10.0, 10.0, 10.50, '2026-07-03 18:00:00'),
(3001, 1011, 1018,  9.0,  9.0, 10.00, '2026-07-03 18:00:00'),
(3002, 1009, 1017,  5.0,  5.0, 13.50, '2026-07-04 17:00:00'),
(3003, 1010, 1014,  7.0,  7.0, 10.50, '2026-07-05 17:00:00'),
(3004, 1012, 1016,  5.0,  5.0, 11.00, '2026-07-06 17:00:00'),
(3005,    2, 1013,  6.0,  6.0, 10.50, '2026-07-07 17:00:00'),
(3006,    1,    1, 10.5, 10.5, 14.00, '2026-07-02 18:00:00'),
(3007, 1009, 1017,  4.0,  4.0, 13.50, '2026-07-03 18:00:00'),
(3008,    1,    1, 18.0, 16.0, 14.00, '2026-07-04 18:00:00'),
(3008, 1011, 1018, 18.0, 14.0, 10.00, '2026-07-04 18:00:00'),
(3009, 1012, 1016,  6.0,  6.0, 11.00, '2026-07-08 18:00:00'),
(3010, 1013,    3,  4.5,  4.5,  9.50, '2026-07-08 18:00:00'),
(3011,    2,    1,  8.5,  8.5, 10.50, '2026-07-09 18:00:00'),
(3011, 1014, 1018,  8.5,  8.5, 13.00, '2026-07-09 18:00:00'),
(3012, 1009, 1017,  4.0,  4.0, 13.50, '2026-07-09 18:00:00'),
(3013, 1010, 1019,  4.5,  4.5, 10.50, '2026-07-09 18:00:00'),
(3014, 1010, 1014,  6.0,  6.0, 10.50, '2026-07-10 12:00:00'),
(3015, 1012, 1016,  4.0,  4.0, 11.00, '2026-07-10 12:00:00'),
(3016,    1,    1, 10.0, 10.0, 14.00, '2026-07-10 12:00:00'),
(3016, 1011, 1018, 10.0, 10.0, 10.00, '2026-07-10 12:00:00'),
(3017,    2, 1015,  8.0,  8.0, 10.50, '2026-07-10 12:00:00'),
(3017, 1013, 1019,  8.0,  4.0,  9.50, '2026-07-10 12:00:00'),
(3018, 1009, 1017,  5.5,  5.5, 13.50, '2026-07-10 12:00:00');


-- ═══════════════════════════════════════════════════════════════
-- PART 6 — Reviews (RATED requests 3006-3008) — IDs 3001-3006
-- ═══════════════════════════════════════════════════════════════
INSERT INTO reviews (id, request_id, author_id, target_id, rating, comment, created_at) VALUES
(3001, 3006, 2, 6, 5, 'Subsolagem impecável. O António arejou o terreno todo sem deixar zonas por fazer. Muito profissional.', '2026-07-04 10:00:00'),
(3002, 3006, 6, 2, 5, 'Cliente atencioso e terreno bem identificado. Tudo a postos para o trabalho. Recomendo.',                  '2026-07-04 11:00:00'),
(3003, 3007, 3, 6, 4, 'Tratamento bem feito e atempado. Apenas um pequeno atraso à chegada — de resto, excelente.',                '2026-07-05 09:00:00'),
(3004, 3007, 6, 3, 5, 'Vinha bem tratada pelo cliente, fácil acesso. Combinação clara. Obrigado!',                                 '2026-07-05 10:00:00'),
(3005, 3008, 11, 6, 5, 'Lavoura de 6 hectares no Faial impecável, mesmo com a deslocação inter-ilhas. Equipa muito competente.',   '2026-07-07 09:00:00'),
(3006, 3008, 6, 11, 5, 'Trabalho exigente mas bem coordenado pelo cliente. Voltaríamos a colaborar de certeza.',                   '2026-07-07 10:00:00');
...
BEGIN
  ...
  INSERT INTO _july_mov (seq, item_id, mtype, delta, ucost, reason, actor, created) VALUES
    ...
    (6, 1015, 'CONSUMPTION',  -12.000, NULL, 'Consumo — pulverização pomar (exec 3002)',       6, '2026-07-05 13:00:00'),
    (7, 1014, 'CONSUMPTION',  -16.000, NULL, 'Consumo — herbicida milho (exec 3004)',          6, '2026-07-07 12:30:00'),
    (8, 1015, 'CONSUMPTION',   -9.000, NULL, 'Consumo — tratamento vinha (exec 3007)',         6, '2026-07-04 12:00:00'),
    (9, 1013, 'CONSUMPTION', -250.000, NULL, 'Consumo — adubação pastagem (exec 3009)',        6, '2026-07-09 14:00:00'),
...
(6, 'PROPOSAL_ACCEPTED', 'Proposta aceite!',    'A sua proposta para a lavoura do João Silva foi aceite.',              '{"requestId": 3011, "proposalId": 3011}'::jsonb, TRUE,  '2026-07-07 09:05:00'),
(6, 'REQUEST_CONFIRMED', 'Trabalho confirmado', 'O cliente confirmou a subsolagem de 4 hectares.',                      '{"requestId": 3006}'::jsonb,                     TRUE,  '2026-07-04 10:05:00'),
(6, 'REVIEW_RECEIVED',   'Nova avaliação',      'Recebeu uma avaliação de 5 estrelas pela subsolagem.',                 '{"requestId": 3006, "reviewId": 3001}'::jsonb,   FALSE, '2026-07-04 10:10:00'),
(6, 'REVIEW_RECEIVED',   'Nova avaliação',      'Recebeu uma avaliação de 5 estrelas pela lavoura no Faial.',           '{"requestId": 3008, "reviewId": 3005}'::jsonb,   FALSE, '2026-07-07 09:05:00'),
(6, 'EXECUTION_COMPLETED','Serviço a confirmar','A adubação de pastagem foi concluída e aguarda confirmação.',          '{"requestId": 3009}'::jsonb,                     FALSE, '2026-07-09 14:05:00'),
(2, 'EXECUTION_STARTED', 'Trabalho iniciado',   'AgroServiços iniciou a lavoura do seu terreno.',                       '{"requestId": 3011}'::jsonb,                     FALSE, '2026-07-10 07:50:00'),
(2, 'PROPOSAL_RECEIVED', 'Nova proposta recebida','Recebeu uma proposta para a subsolagem de pastagem.',                '{"requestId": 3019, "proposalId": 3019}'::jsonb, FALSE, '2026-07-09 09:05:00'),
(1020,'PROPOSAL_RECEIVED','Nova proposta recebida','Recebeu uma proposta para o tratamento de batata.',                  '{"requestId": 3020, "proposalId": 3021}'::jsonb, FALSE, '2026-07-09 11:35:00');
